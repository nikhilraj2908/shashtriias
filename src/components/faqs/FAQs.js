        ...
        <div class="footer1">
            <div class="footer-body">
                ...
                <div class="footer-nav">
                    <nav class="mt-3 me-4" >
                        <a class="whatsapp" target="blank" href="https://chat.whatsapp.com/JMvqkwryPrHKLEDu8tNmYy"><span class="bi bi-whatsapp me-2 " style="font-size: 20px; color: rgb(110, 179, 7);"></span></a>
